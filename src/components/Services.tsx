...
import { OPEN_SERVICE_EVENT } from '../lib/eventBus';
...
export default function Services() {
  ...
  // Let the Navbar's Services mega menu open a specific service's detail modal directly.
  useEffect(() => {
    ...
    window.addEventListener(OPEN_SERVICE_EVENT, handler);
    return () => window.removeEventListener(OPEN_SERVICE_EVENT, handler);
  }, []);
