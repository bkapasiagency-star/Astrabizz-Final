      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div ref={headerRef} className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          ...
          <p className="text-slate-600 dark:text-slate-300 font-sans text-sm max-w-xl mx-auto leading-relaxed">
            Whether you're planning an ERP implementation, modernizing your CRM, adopting Artificial Intelligence, or driving enterprise-wide digital transformation, Astrabizz Consultancy is ready to help you turn strategy into measurable business outcomes.
          </p>
          <p className="text-slate-800 dark:text-slate-200 font-display font-semibold text-sm max-w-xl mx-auto leading-relaxed">
            Let's build a smarter, more agile, and future-ready business together.
          </p>
        </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                      ...
                      <div className="grid md:grid-cols-2 gap-4">
                        <div className="space-y-1.5">
                          ...
                          >
                            {INDUSTRIES.map((ind) => (
                              <option key={ind.id} value={ind.name} className="dark:bg-slate-800">{ind.name}</option>
                            ))}
                        ...
                        <div className="space-y-1.5">
                          ...
                          >
                            {SERVICES.map((srv) => (
                              <option key={srv.id} value={srv.title} className="dark:bg-slate-800">{srv.title}</option>
                            ))}
                            <option value="Other" className="dark:bg-slate-800">Other</option>
                          </select>
                        </div>
                      ...
                      {status === 'error' && (
                        <p className="text-xs text-center font-semibold text-red-500">
                          Something went wrong sending your request. Please try again, or email us directly at{' '}
                          <a href="mailto:info@astrabizz.com" className="underline">info@astrabizz.com</a>.
                        </p>
                      )}
                    </form>
                  </motion.div>
